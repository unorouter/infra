...
- node1 cx33 fsn1 (<node1-public-ip>, 10.100.1.1) + node2 cpx22 nbg1 (10.100.1.2) + node4
  cx23 hel1 (<retired-node4-public-ip>, 10.100.1.4). All k3s SERVERS, embedded etcd -- quorum survives
