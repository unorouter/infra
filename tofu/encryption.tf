...
# secret/tofu state_passphrase, mirrored in .env as TF_VAR_state_passphrase. enforced=false
# lets the first run read the pre-encryption plaintext; flip it to true once migrated.
